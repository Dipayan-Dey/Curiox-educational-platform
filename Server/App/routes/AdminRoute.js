...
import { allDeltails, createCourse, deleteCourse, deleteLacture, getAllUser, UpdateRole, uploadLancture } from "../controllers/AdminController.js";
...
AdminRoute.post("/createLacture/:id",isAuth,isAdmin,uploadFiles,uploadLancture)
